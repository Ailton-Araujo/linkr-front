...
const TopMenu = () => {
    ...
    const retrieveUserInfo = async (token) => {
        const promise = axios.get(`${process.env.REACT_APP_API_URI}/userinfo`, {headers: {authorization: `Bearer ${token}`}});
        promise.then((res) => {
    ...
    return (
        ...
        <Logout dropdown={dropDown}><p onClick={logout}>logout</p></Logout>
        </>
    );
};
